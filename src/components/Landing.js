...
const Landing = ({ children }) => {
    ...
    return (_jsxs("div", { style: { position: 'relative', width: 'full', height: 'full' }, children: [_jsx("div", { ref: mountRef, style: { position: 'absolute', top: 0, left: -300, width: '100%', height: '100%' } }), _jsx("div", { style: { position: 'relative', zIndex: 1 }, children: children })] }));
};
